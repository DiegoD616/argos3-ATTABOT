/**
 * @file <argos3/plugins/robots/attabot/control_interface/ci_attabot_light_sensor.h>
 *
...
#ifndef CCI_ATTABOT_LIGHT_SENSOR_H
#define CCI_ATTABOT_LIGHT_SENSOR_H

namespace argos {
   class CCI_AttabotLightSensor;
}
...
namespace argos {
   ...
   class CCI_AttabotLightSensor : public CCI_Sensor {
   ...
   public:
      ...
      CCI_AttabotLightSensor();
      virtual ~CCI_AttabotLightSensor() {}
   ...
   std::ostream& operator<<(std::ostream& c_os, const CCI_AttabotLightSensor::SReading& s_reading);
   std::ostream& operator<<(std::ostream& c_os, const CCI_AttabotLightSensor::TReadings& t_readings);
