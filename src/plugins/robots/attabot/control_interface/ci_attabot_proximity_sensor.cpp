/**
 * @file <argos3/plugins/robots/attabot/control_interface/ci_attabot_proximity_sensor.cpp>
 *
 * @author Carlo Pinciroli <ilpincy@gmail.com>
 */

#include "ci_attabot_proximity_sensor.h"
...
namespace argos {
   ...
   CCI_AttabotProximitySensor::CCI_AttabotProximitySensor() :
      m_tReadings(8) {
   ...
   const CCI_AttabotProximitySensor::TReadings& CCI_AttabotProximitySensor::GetReadings() const {
     return m_tReadings;
   }
...
#ifdef ARGOS_WITH_LUA
   void CCI_AttabotProximitySensor::CreateLuaState(lua_State* pt_lua_state) {
...
#ifdef ARGOS_WITH_LUA
   void CCI_AttabotProximitySensor::ReadingsToLuaState(lua_State* pt_lua_state) {
   ...
   std::ostream& operator<<(std::ostream& c_os,
                            const CCI_AttabotProximitySensor::SReading& s_reading) {
   ...
   std::ostream& operator<<(std::ostream& c_os,
                            const CCI_AttabotProximitySensor::TReadings& t_readings) {
      if(! t_readings.empty()) {
