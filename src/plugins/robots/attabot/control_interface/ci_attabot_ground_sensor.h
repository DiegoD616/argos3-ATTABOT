/**
 * @file <argos3/plugins/robots/attabot/control_interface/ci_attabot_ground_sensor.h>
 *
...
#ifndef CCI_ATTABOT_GROUND_SENSOR_H
#define CCI_ATTABOT_GROUND_SENSOR_H

namespace argos {
   class CCI_AttabotGroundSensor;
}
...
namespace argos {
   ...
   class CCI_AttabotGroundSensor : virtual public CCI_Sensor {
   ...
   public:
      ...
      CCI_AttabotGroundSensor();

      virtual ~CCI_AttabotGroundSensor() {}
