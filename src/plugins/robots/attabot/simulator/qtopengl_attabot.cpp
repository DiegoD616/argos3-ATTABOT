/**
 * @file <argos3/plugins/robots/attabot/simulator/qtopengl_attabot.cpp>
 *
 * @author Carlo Pinciroli - <ilpincy@gmail.com>
 */

#include "qtopengl_attabot.h"
...
namespace argos {
   ...
   CQTOpenGLAttabot::CQTOpenGLAttabot() :
      m_unVertices(40) {
      /* Reserve the needed textures */
      m_pcTextures[0] = MakeTexture("attabot_texture_top.png");
      m_pcTextures[1] = MakeTexture("attabot_texture_bottom.png");
      m_pcTextures[2] = MakeTexture("attabot_texture_side.png");
   ...
   void CQTOpenGLAttabot::Draw(CAttabotEntity& c_entity) {
      /* Place the body */
   ...
   void CQTOpenGLAttabot::SetLEDMaterial(GLfloat f_red, GLfloat f_green, GLfloat f_blue) {
   ...
   void CQTOpenGLAttabot::RenderBase() {
      ...
      glVertex3f(0.0, 0.0, ATTABOT_BASE_TOP);
      CVector2 cVert(1.0, 0.0);
      glTexCoord2f(0.5 + 0.5 * cVert.GetX(),
                   0.5 + 0.5 * cVert.GetY());
      glVertex3f(ATTABOT_BASE_RADIUS * cVert.GetX(),
                 ATTABOT_BASE_RADIUS * cVert.GetY(),
                 ATTABOT_BASE_TOP);
   ...
   void CQTOpenGLAttabot::RenderLED() {
   ...
   class CQTOpenGLOperationDrawAttabotNormal : public CQTOpenGLOperationDrawNormal {
   public:
      void ApplyTo(CQTOpenGLWidget& c_visualization,
                   CAttabotEntity& c_entity) {
         static CQTOpenGLAttabot m_cModel;
   ...
   class CQTOpenGLOperationDrawAttabotSelected : public CQTOpenGLOperationDrawSelected {
   public:
      void ApplyTo(CQTOpenGLWidget& c_visualization,
                   CAttabotEntity& c_entity) {
   ...
   REGISTER_QTOPENGL_ENTITY_OPERATION(CQTOpenGLOperationDrawNormal, CQTOpenGLOperationDrawAttabotNormal, CAttabotEntity);

   REGISTER_QTOPENGL_ENTITY_OPERATION(CQTOpenGLOperationDrawSelected, CQTOpenGLOperationDrawAttabotSelected, CAttabotEntity);
