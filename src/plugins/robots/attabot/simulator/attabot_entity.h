/**
 * @file <argos3/plugins/robots/attabot/simulator/attabot_entity.h>
 *
 * @author Carlo Pinciroli - <ilpincy@gmail.com>
 */

#ifndef ATTABOT_ENTITY_H
#define ATTABOT_ENTITY_H
...
namespace argos {
   ...
   class CAttabotEntity : public CComposableEntity {
   ...
   public:
      ...
      CAttabotEntity(const std::string& str_id,
