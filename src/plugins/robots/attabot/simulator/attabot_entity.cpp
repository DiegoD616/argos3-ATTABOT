/**
 * @file <argos3/plugins/robots/attabot/simulator/attabot_entity.cpp>
 *
 * @author Carlo Pinciroli - <ilpincy@gmail.com>
 */

#include "attabot_entity.h"
...
namespace argos {
   ...
   CAttabotEntity::CAttabotEntity(const std::string& str_id,
      ...
      try {
         ...
         m_pcWheeledEntity->SetWheel(0, CVector3(0.0f,  ATTABOT_HALF_WHEEL_DISTANCE, 0.0f), ATTABOT_WHEEL_RADIUS);
         m_pcWheeledEntity->SetWheel(1, CVector3(0.0f, -ATTABOT_HALF_WHEEL_DISTANCE, 0.0f), ATTABOT_WHEEL_RADIUS);
         /* LED equipped entity */
         m_pcLEDEquippedEntity = new CLEDEquippedEntity(this, "leds_0");
         AddComponent(*m_pcLEDEquippedEntity);
         m_pcLEDEquippedEntity->AddLED(ATTABOT_LEDS_OFFSET[0],
                                       m_pcEmbodiedEntity->GetOriginAnchor());
         m_pcLEDEquippedEntity->AddLED(ATTABOT_LEDS_OFFSET[1],
                                       m_pcEmbodiedEntity->GetOriginAnchor());
         m_pcLEDEquippedEntity->AddLED(ATTABOT_LEDS_OFFSET[2],
                                       m_pcEmbodiedEntity->GetOriginAnchor());
         ...
         m_pcProximitySensorEquippedEntity->AddSensorRing(
            CVector3(0.0f, 0.0f, ATTABOT_IR_SENSORS_RING_ELEVATION),
            ATTABOT_IR_SENSORS_RING_RADIUS,
            CRadians::ZERO,
            ATTABOT_IR_SENSORS_RING_RANGE,
            8,
            m_pcEmbodiedEntity->GetOriginAnchor());
         ...
         for(UInt32 i = 0; i < 5; ++i) {
            m_pcUltrasoundSensorEquippedEntity->AddSensor(
               CVector3(ATTABOT_ULTRASOUND_SENSORS_RING_RADIUS +
                        ATTABOT_ULTRASOUND_SENSORS_RING_RANGE.GetMin(),
                        CRadians::ZERO,
                        ULTRASOUND_SENSOR_ANGLES[i]), // offset
               CVector3(1.0,
                        CRadians::ZERO,
                        ULTRASOUND_SENSOR_ANGLES[i]), // direction
               ATTABOT_ULTRASOUND_SENSORS_RING_RANGE.GetMax(),
               m_pcEmbodiedEntity->GetOriginAnchor());
         }
         ...
         m_pcGroundSensorEquippedEntity->AddSensor(ATTABOT_IR_SENSORS_GROUND_OFFSET[0],
                                                   CGroundSensorEquippedEntity::TYPE_GRAYSCALE,
                                                   m_pcEmbodiedEntity->GetOriginAnchor());
         m_pcGroundSensorEquippedEntity->AddSensor(ATTABOT_IR_SENSORS_GROUND_OFFSET[1],
                                                   CGroundSensorEquippedEntity::TYPE_GRAYSCALE,
                                                   m_pcEmbodiedEntity->GetOriginAnchor());
         m_pcGroundSensorEquippedEntity->AddSensor(ATTABOT_IR_SENSORS_GROUND_OFFSET[2],
                                                   CGroundSensorEquippedEntity::TYPE_GRAYSCALE,
                                                   m_pcEmbodiedEntity->GetOriginAnchor());
         m_pcGroundSensorEquippedEntity->AddSensor(ATTABOT_IR_SENSORS_GROUND_OFFSET[3],
                                                   CGroundSensorEquippedEntity::TYPE_GRAYSCALE,
                                                   m_pcEmbodiedEntity->GetOriginAnchor());
         /* RAB equipped entity */
         m_pcRABEquippedEntity =
            new CRABEquippedEntity(this,
                                   ...
                                   m_pcEmbodiedEntity->GetOriginAnchor(),
                                   *m_pcEmbodiedEntity,
                                   CVector3(0.0f, 0.0f, ATTABOT_BASE_TOP));
   ...
   void CAttabotEntity::Init(TConfigurationNode& t_tree) {
      try {
         /*
          * Init parent
          */
   ...
   void CAttabotEntity::UpdateComponents() {
   ...
   REGISTER_ENTITY(CAttabotEntity,
                   "attabot",
                   "Carlo Pinciroli [ilpincy@gmail.com]",
                   "1.0",
                   "The attabot robot.",
                   "The attabot is a commercial, extensible robot produced by K-Teams. More\n"
                   ...
                   "attabot in the arena. When the robot is untranslated and unrotated, the\n"
                   ...
                   "The 'body/orientation' attribute specifies the orientation of the attabot.\n"
                   ...
                   "attabot. The value of the attribute must be set to the id of a previously\n"
                   "defined controller. Controllers are defined in the <controllers> XML subtree.\n\n"
                   "OPTIONAL XML CONFIGURATION\n\n"
                   "You can set the emission range of the range-and-bearing system. By default, a\n"
                   "message sent by a attabot can be received up to 3m. By using the 'rab_range'\n"
                   "attribute, you can change it to, i.e., 4m as follows:\n\n"
                   "  <arena ...>\n"
                   "    ...\n"
                   "    <attabot id=\"kh0\" rab_range=\"4\">\n"
                   ...
                   "  <arena ...>\n"
                   "    ...\n"
                   "    <attabot id=\"kh0\" rab_data_size=\"100\">\n"
                   "      <body position=\"0.4,2.3,0.25\" orientation=\"45,0,0\" />\n"
                   "      <controller config=\"mycntrl\" />\n"
                   "    </attabot>\n"
                   "    ...\n"
   ...
   REGISTER_STANDARD_SPACE_OPERATIONS_ON_COMPOSABLE(CAttabotEntity);
